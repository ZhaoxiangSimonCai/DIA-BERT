...
**A:** You can provide comma-separated mzML paths, a directory (loads all *.mzML and *.d inside), or glob patterns. To combine the results of individual analyses for cross-run quantification, you can set the following parameters:  
  --open_identify=0 --open_cross_quantification=1  
Examples:  
  cd /DIA_BERT/00Versions/v1.1; python main_linux.py  
  --rawdata_file_dir_path=/data/run1.mzML,/data/run2.mzML  
  --rawdata_file_dir_path=/data/runs_directory/  
  --rawdata_file_dir_path='/data/project/*.mzML'  
